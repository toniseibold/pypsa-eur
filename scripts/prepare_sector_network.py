...
def create_network_topology(
    ...
    candidates = pd.concat(
        [n.lines[ln_attrs],
         n.links.loc[n.links.carrier.isin(carriers) & (n.links.underwater_fraction > 0.1), lk_attrs]]
    ).fillna(0)
...
def add_industry(
    ...
    options : dict
        ...
        - and others
    carrier_networks: dict #TONITODO
    spatial : object
